...
#define STRING_CONFIG_H_AUTHOR "(ATMAT)" // Who made the changes.
//#define CUSTOM_VERSION_FILE Version.h // Path from the root directory (no quotes)

/** CHOOSE YOUR MACHINE:
* Signal Pro [czarny] 300 V2 :      SIGNAL_PRO_300_V2
* Signal Pro [czarny] 500 V2 :      SIGNAL_PRO_500_V2

*/
#define SIGNAL_PRO_300_V2
...
#if ANY(SIGNAL_PRO_300_V2, SIGNAL_PRO_500_V2)
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 45.21
  #define DEFAULT_bedKi 2.48
  #define DEFAULT_bedKd 549.74
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 142.2222, 142.2222, 800, 830 }
 ...
 *   (0,0)
 */
#if ANY(SIGNAL_PRO_500_V2, SIGNAL_PRO_300_V2)
#define NOZZLE_TO_PROBE_OFFSET { 10, 95, 0 }
#endif

// If You are using aluminium block for calibration Z_offset, set it height here:
#define CALIBRATION_BLOCK_HEIGHT 10
...
#define Z_PROBE_FEEDRATE_SLOW ((4*60) * 2 / 3)
...
// @section machine
  ...
  #ifdef SIGNAL_PRO_300_V2
   #define Z_MAX_POS 302
  #endif
  #ifdef SIGNAL_PRO_500_V2
   #define Z_MAX_POS 502
  #endif
#endif
...
#define AUTOCALIBRATION_SCRIPT "G28\nG34\nG29"
#define MEASURMENT_SCRIPT "G28\nM420 S1\nG42 F3600 I2 J2\nG0 Z10 F120\nM114"
#define MEASURMENT_ACCEPTATION_SCRIPT "M853"
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN     13       // LED driving pin
  ...
  //#define NEOPIXEL_BKGD_LED_INDEX  6               // Index of the LED to use
